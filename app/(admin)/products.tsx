...
export default function AdminProductsScreen(): React.ReactElement {
  ...
  const saveProduct = async (): Promise<void> => {
    try {
      ...
      formData.append("points", (currentProduct.points || "0").toString());
      ...
      <View style={styles.productDetails}>
        <View style={styles.priceStockContainer}>
          ...
          <View style={styles.stockContainer}>
            <Text style={[styles.stockValue, styles.stockHigh]}>
              {item.points} points
            </Text>
          </View>
        </View>
            ...
            >
              ...
              <View style={styles.formRow}>
                ...
                <View style={[styles.formField, { flex: 1, marginLeft: 8 }]}>
                  <Text style={styles.fieldLabel}>Point *</Text>
                  <TextInput
                    style={styles.textInput}
                    placeholder="0"
                    placeholderTextColor="#6b7280"
                    ...
                    onChangeText={(text) =>
                      setCurrentProduct({ ...currentProduct, points: text })
                    }
                  />
                </View>
              </View>
